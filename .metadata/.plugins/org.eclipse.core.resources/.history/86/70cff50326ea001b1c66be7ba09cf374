package com.eagleeye.licenses.model;
...
public class License {
	...
	public String toString() {
		return "License [licenseId=" + licenseId + ", organizationId=" + organizationId + ", productName=" + productName
				+ ", licenseType=" + licenseType + ", licenseMax=" + licenseMax + ", licenseAllocated="
				+ licenseAllocated + ", comment=" + comment + "]";
	}
